...
class Debt(models.Model):
    ...
    Модель долгов
    """
    from_member = models.ForeignKey(Member, on_delete=CASCADE, null=True, related_name='from_member', verbose_name="Должник")
    to_member = models.ForeignKey(Member, on_delete=CASCADE, null=True, related_name='to_member', verbose_name="Получатель")
    ...
    def __str__(self) -> str:
        return f"{self.from_member} =={self.amount}==> {self.to_member} (Счет: {self.check_obj})"
